# Makefile for FUE 1.13.1 (console engine)
...
uninstall:
	rm -f /usr/local/bin/fue$(EXE_EXT)
...
$(BUILD_DIR)/drvmlest.o:        include/fue.h include/nlatools.h
$(BUILD_DIR)/elfvarma.o:        include/fue.h include/nlatools.h
